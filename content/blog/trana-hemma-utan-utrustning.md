...
Och när du är redo att ta nästa steg — när hemmaträningen blivit en vana och du vill lägga till lite motstånd — hittar du flera bra alternativ i Fyndplats [Träningskategori](https://www.fyndplats.se/kategori/traning-gym). Och ja, vi har också skrivit en del om [hemmakontor-tips](https://www.fyndplats.se/blogg/hemmakontor-tips) — för en bra rygg byggs både i träningen *och* vid skrivbordet.
...
```json
{
  ...
  "@type": "Article",
  "headline": "Träna hemma utan utrustning: nybörjarguiden som funkar",
  "description": "Träna hemma utan utrustning. En enkel nybörjarguide med 10 kroppsviktsövningar och ett 4-veckorsprogram du faktiskt klarar — utan gym eller dyra prylar.",
  "image": "https://www.fyndplats.se/blogg/bilder/trana-hemma-utan-utrustning-cover.jpg",
  "author": {
    "@type": "Organization",
    "name": "Fyndplats"
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.fyndplats.se/blogg/trana-hemma-utan-utrustning"
  }
}
```
