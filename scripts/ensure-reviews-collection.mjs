...
const COLLECTIONS = [
  {
    ...
    fields: [
      ...
      { key: "textOriginal", displayName: "Original Text", type: "TEXT" },
      { key: "textSwedish", displayName: "Swedish Text", type: "TEXT" },
      { key: "customerName", displayName: "Customer Name", type: "TEXT" },
      { key: "customerCountry", displayName: "Customer Country", type: "TEXT" },
      ...
      { key: "hidden", displayName: "Hidden", type: "BOOLEAN" },
