...
function bboxToCrop(bbox, ow, oh) {
  ...
  // Reverterad 2026-06-03 efter att Leonard rapporterade att `min` klippte bort
  // toppen av Gua Sha-stenen — vi prioriterar att visa hela produkten över att
  // helt eliminera vit padding på kortsidan.
