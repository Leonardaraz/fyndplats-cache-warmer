...
export function buildTranslatePrompt(
  ...
  const huvud = [
    ...
    "- Inga tankstreck (– eller —), inga semikolon och inga citattecken. Skriv punkt,",
    "  komma, \"och\" eller \"men\" i stället. Korta meningar och vanliga ord.",
    "- Undvik stela AI-fraser som \"Sammantaget\", \"helt och hållet\" och \"förhållandet",
    "  mellan pris och kvalitet\". Skriv enkelt: \"prisvärd\", \"rekommenderar\", \"funkar bra\".",
