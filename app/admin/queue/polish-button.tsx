...
export function PolishButton({
  ...
  const payload = [
    ...
    "kinesiska) där det går, Steg 3c: gör HJÄLTEBILDEN till en ren produktbild på vit",
    "studio-bakgrund (med mjuk skugga) om originalet har ful/mörk/rörig bakgrund — behåll",
    "nyttiga kontextbilder, släng infografik, granska resultatet med Read, samt att",
    "PUBLICERA produkten (visible:true) när poleringen är klar och verifierad.",
    "",
