...
const faqs: { q: string; a: string }[] = [
  ...
  { q: "Kan jag ångra mitt köp / returnera?", a: `${TOTAL_SUMMARY} Under de första 14 dagarna har du rätt att undersöka produkten som du skulle ha gjort i en butik; har den hanterats mer än så kan ett skäligt värdeminskningsavdrag göras. För det frivilliga öppna köpet dag 15–30 ska produkten vara oanvänd, komplett och i säljbart skick. Enklast ångrar du direkt på sidan Ångra köp (fyndplats.se/angra-kop): fyll i din order, välj vilka artiklar du vill ångra och skicka, så får du ett automatiskt mottagningskvitto med returadressen. Ångerrätten gäller även innan paketet hunnit fram. Returfrakten betalas av kunden (välj valfri leveranstjänst, gärna spårbar). Vi återbetalar inom 5–10 bankdagar efter mottagen retur. Är varan trasig eller fel är det istället en reklamation – då står Fyndplats för returfrakten.` },
