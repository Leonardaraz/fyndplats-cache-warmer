...
const faqs: { q: string; a: string }[] = [
  ...
  { q: "Kan jag ångra mitt köp?", a: "Ja, du har 14 dagars ångerrätt enligt distansavtalslagen. Kontakta info@fyndplats.com eller fyll i kontaktformuläret med ditt ordernummer så skickar vi en retursedel. Returkostnaden är 41–167 kr beroende på produktens vikt." },
