    ...
    >
      ...
      <div className="callout">
        <p>
          ...
          Momsregistreringsnummer: SE199509144037 01<br />
      ...
      <p>Normal leveranstid är <strong>5–15 arbetsdagar</strong> från det att beställningen bekräftats. Leveranstiden kan variera beroende på produkt, lager och säsong. Aktuell leveranstid visas i kassan och uppdaterad status skickas via e-post.</p>
