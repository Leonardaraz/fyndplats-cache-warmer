...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "sv_SE", siteName: "Fyndplats", url: "https://www.fyndplats.se/returer", title: "Returer & ångerrätt", description: "30 dagars öppet köp hos Fyndplats. Anmäl din retur via mejl, packa säkert och skicka tillbaka — så här går det till, steg för steg.", images: ["https://static.wixstatic.com/media/b379ce_0e6a6260c9f243b3afd79cbaf147b67b~mv2.jpg/v1/fill/w_1200,h_630,al_c,q_85,enc_avif/file.jpg"] },
};
