...
// VÄRMNINGEN AV HELA KATALOGEN BOR INTE HÄR LÄNGRE.
//
// Den flyttade till /api/cron/varm-katalogen, som går var 15:e minut. Skälet är
// den här rutten själv: färskpasset nedan aviserar IndexNow inom ett
// 90-minutersfönster (FONSTER_MS), så en kvartscron hade pingat samma produkter
// sex gånger. Med två rutter kapas fönstret efter en deploy från 60 till 15
// minuter utan att röra aviseringskadensen.
//
// Kvar här: färska produkter renderas och aviseras, i timtakt. Den delade
// värmningskoden ligger i lib/warm.ts.
