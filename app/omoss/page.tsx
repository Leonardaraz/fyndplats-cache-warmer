...
export default function OmOss() {
  return (
    ...
    >
      ...
      <p><strong>Frakt och leverans.</strong> Standardfrakt är 19 kr inom Sverige, och fri frakt över 499 kr. Leveranstiden är normalt 3–6 vardagar – när din beställning skickas får du en spårningskod via mejl.</p>
