...
export default function AnvandarvillkorApp() {
  return (
    ...
    >
      ...
      <p>Normal leveranstid är <strong>5–15 arbetsdagar</strong> från bekräftad beställning. Fri frakt vid köp över <strong>499 kr</strong>; vid mindre köp tillkommer en fraktavgift som visas i kassan. Vid förseningar över 30 dagar har du rätt att häva köpet och få full återbetalning.</p>
