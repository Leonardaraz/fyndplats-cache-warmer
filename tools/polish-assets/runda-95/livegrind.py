# -*- coding: utf-8 -*-
"""Runda 95 — Steg 14: mekanisk grind mot de PUBLICERADE sidorna.
...
FORBJUDET = [
    ...
    (r"01-0083|100110-05", "leverantorens artikelnummer"),
    (r"tyskland|spanien|skickas från", "avsandarland"),
    (r"kolgrå|kaffebrun", "farg som kallan har FEL om"),
    (r"leverantör|tillverkar", "mot kunden ar VI leverantoren"),
    (r"https:/produkt", "trasig relativ lank"),
]


def hamta(slug):
    u = "https://www.fyndplats.se/produkt/%s?cb=r95" % slug
...
def kor():
    ...
    for pid in T.PRODUKTER:
        ...
        if kod != "200":
            ...
            # alt-texter: VARA sex ska finnas och vara inbordes olika
