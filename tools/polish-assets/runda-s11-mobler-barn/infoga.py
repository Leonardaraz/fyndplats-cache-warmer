...
# Slugar att lägga in; utan argument rundans sju sökordskategorier. Inga befintliga poster byts i S11.
NYA = sys.argv[2:] or ["pallar","sittpuffar-fotpallar","kladhangare-hallmobler","sideboards-vitrinskap","vinstall-vinkylar","barnmobler","projektordukar"]
ERSATT = []
