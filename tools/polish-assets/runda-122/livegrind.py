# -*- coding: utf-8 -*-
"""Runda 122 Steg 14 — grindar den PUBLICERADE sidan, inte utkastet.
...
# ☠️ BARA DE TRE PUBLICERADE. `832f9eec` är slutsåld hos Aosom och ligger kvar
#    som utkast — dess URL svarar 404, och en grind som fäller på det hade
#    lärt mottagaren att ignorera raden.
PUBLICERADE = {"6490e360", "0cbffcd9", "740fa6d0"}
...
if __name__ == "__main__":
    import json
    d = {k: v for k, v in json.load(open("skrivning.json")).items()
         if k in PUBLICERADE}
    totalt = 0
