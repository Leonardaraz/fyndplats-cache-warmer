...
# Slugar att lägga in; utan argument rundans nya sida. S12 byter dessutom ut två befintliga poster:
# Massage & Återhämtning och Kropp & Välbefinnande siktade båda på "massagebänk", som nu får en egen sida.
NYA = sys.argv[2:] or ["massagebankar"]
ERSATT = ["massage-aterhamtning", "kropp-valbefinnande"]
