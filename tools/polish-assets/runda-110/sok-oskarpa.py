# -*- coding: utf-8 -*-
"""Runda 110 — mäter oskärpan per kort.

Metoden är runda 108/109:s och står oemotsagd; det som mäts om är RADIEN, för
den beror på VÄVENS MÖNSTER och inte på modellen. Rundan har tre olika vävar,
så tre olika svar är att vänta.

Runda 108:s två ihjälslagna hypoteser står kvar där: krympa varan (fungerar men
lämnar en liten vara i ett stort vitt fält) och nedsampla fotot (SVAGARE än
oskärpa, tvärtemot antagandet).
"""
import importlib.util, os, sys
from PIL import Image, ImageFilter

BAS = "/home/user/fyndplats-cache-warmer/tools/polish-assets"
sys.path.insert(0, BAS); sys.path.insert(0, BAS + "/runda-110")
import kortbygge                                                   # noqa
import cardkit as ck                                               # noqa
import texter as T                                                 # noqa
import kort as K                                                   # noqa

_s = importlib.util.spec_from_file_location("pf", BAS + "/runda-110/bygg-panelfoton.py")
