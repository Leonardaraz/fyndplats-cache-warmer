...
# Slugar att lägga in; utan argument rundans tre sökordskategorier plus omtiteln.
NYA = sys.argv[2:] or ["hantlar-hantelset","traningsbankar","motionscyklar"]
# Träning & Gym byter sökord (hantlar -> hemmagym), så att den inte konkurrerar med Hantlar-sidan.
ERSATT = ["traning-gym"] if len(sys.argv) <= 2 else []
