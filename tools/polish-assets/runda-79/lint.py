# -*- coding: utf-8 -*-
"""Runda 79 — grinden mot rundans egna texter, före något skrivs till Wix.
...
#   49 + 61  `sadelpall-hjul-49-61-cm-brun`      (publicerad, mätt i Steg 1)
#   48 + 63  `arbetspall-med-hjul` OCH runda 78:s `rullpallar-2-pack-48-63-cm`
#   49 + 65  runda 78:s `arbetspall-rygg-och-fotring`
# ⚠️ Runda 78:s sidor är PUBLICERADE men ligger inte i den här rundans
#    PRODUKTER, så SYSKONTAL täcker dem inte. Talen är lästa i runda 78:s
#    egen `texter.py`, inte gissade.
EXTERN_TAL = {"49 cm", "61 cm", "48 cm", "63 cm", "65 cm"}
