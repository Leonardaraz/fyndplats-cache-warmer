...
if __name__ == "__main__":
    A = ["ad390a36", "c86ff1a6", "5d1696db", "6cf7cfcf"]   # köksvagn, liten/mellan
    B = ["dac7a904", "36526a8d"]                            # lång vagn + utomhusgrillvagn
    D = ["9e5e788c", "d8bbbdde", "e0fed2c9"]                # köksöar med utfällbar skiva
    ark(A, "kontaktark-a.jpg")
    ark(B + D, "kontaktark-b.jpg")
    hornremsa(A + B + D, "kontroll-hornen.jpg")
