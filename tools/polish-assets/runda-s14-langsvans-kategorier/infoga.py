...
# Slugar att lägga in; utan argument rundans fem sökordskategorier. Inga block byts; två titlar byts av titlar.py.
NYA = sys.argv[2:] or ["motorcyklar-for-barn","valphagar-hundhagar","blomstall-vaxthyllor","serveringsvagnar-rullvagnar","odlingslador"]
ERSATT = []
