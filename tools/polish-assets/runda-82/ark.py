# -*- coding: utf-8 -*-
"""Runda 82, Steg 4 — kontaktark över alla bilder, en rad per produkt.

⚠️ Steg 4 ligger FÖRE Steg 5 med flit: leverantörens text motsäger sig själv
   på tre av rundans åtta produkter, och bilden är den enda oberoende källan.
"""
import os, sys, subprocess
from PIL import Image

HAR = os.path.dirname(os.path.abspath(__file__))
VILL = ["d6a11ae3","f5d857b6","2a16c507","9ed7ad7a","85ffb47b",
        "1628620b","4ca8a6c0","ee610afd"]
