# -*- coding: utf-8 -*-
"""Runda 109 — grinden som körs FÖRE någon text når Wix.

Samma grind som runda 108, oförändrad i sak: den läser T.PRODUKTER_IN och
täcker därför automatiskt familjens ÅTTA sidor i stället för sex. Talgrinden
vidgas per korshänvisning, så sexpanelssidornas nya länkar till 160 och 320 cm
prövas mot målets facit och inte mot sidans eget.
