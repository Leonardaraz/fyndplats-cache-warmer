...
# Slugar att lägga in; utan argument rundans sex sökordskategorier.
NYA = sys.argv[2:] or ["kaninburar-marsvinsburar","hamsterburar-gnagarburar","terrarier",
                       "honshus-honsgardar","hundvagnar","vedstall-vedbodar"]
# Ingen befintlig sida byter sökord i den här rundan (se README, avsnitt 1).
ERSATT = []
