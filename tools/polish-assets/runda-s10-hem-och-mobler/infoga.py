...
# Slugar att lägga in; utan argument rundans åtta sökordskategorier plus omtiteln.
NYA = sys.argv[2:] or ["speglar","badrumsspeglar","sidobord","nattduksbord","byraer","bokhyllor","tvattkorgar","vattenkokare-brodrostar"]
# Förvaring släpper byrå och bokhylla (S7-titeln hann aldrig gå live), så att den inte konkurrerar med Byråer och Bokhyllor.
ERSATT = ["forvaring-organisering"] if len(sys.argv) <= 2 else []
