...
# Slugar att lägga in; utan argument rundans tio sökordskategorier. Inga befintliga poster byts i S13.
NYA = sys.argv[2:] or ["soptunnor","miniugnar-airfryers","barbord","snurrfatoljer","oronlappsfatoljer","matgrupper","hornskrivbord","skarmtak-entretak","gnistskydd","elementskydd"]
ERSATT = []
