...
|---|---|---|---|---|---|---|---|
| 40fb1b24 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| c6f8a0f1 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| 8f95113c | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| 41b2bc81 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| 6ab7b3b0 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| b42b4802 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| 2808fff3 | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
| db1d494f | ✓ skriven | ✓ skriven | ✓ success | ✓ skriven | ✓ LIKA | ✓ las | ✓ REN |
...
- Steg 7: `hamta-live.sh 130` startad 19:53; skarp hämtning 8/8 HTTP 200, `age` 140–141 s (färsk rendering, inte en äldre cachad sida). `livegrind.py`: 8/8 REN, orddiff 0 på alla åtta, `exit 0`.
