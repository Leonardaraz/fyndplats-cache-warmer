# -*- coding: utf-8 -*-
"""Runda 86, Steg 14 — läs de sju publicerade sidorna som kund.
...
maxlasten aldrig blandas ihop mellan syskonen (6 / 20 / 40 kg och
43e312b7:s tre olika tal), att `d6666869` aldrig får en maxlast den inte
har, att förankringen bara utlovas på de två skåp där den ingår, att inget
skåp påstås vara bygglovsbefriat, och att ordet "rundan" inte finns
någonstans i kundtexten (grind 5c).
