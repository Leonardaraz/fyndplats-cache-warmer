# -*- coding: utf-8 -*-
"""Runda 123 Steg 14 — grindar den PUBLICERADE sidan, inte utkastet.

Sju av nio publicerades; `46a5eeda` och `db2f05f9` är slutsålda hos Aosom och
ligger kvar som utkast (STEG2-5.md, Steg 3). De hämtas inte.
...
if __name__ == "__main__":
    ...
    # ☠️ Två av nio är SLUTSÅLDA och publicerades aldrig. En live-grind som
    #    hämtar dem får 404 och rapporterar ett fel som inte finns.
    HALLS_TILLBAKA = {"46a5eeda", "db2f05f9"}
    d = {k: v for k, v in d.items() if k not in HALLS_TILLBAKA}
    totalt = 0
