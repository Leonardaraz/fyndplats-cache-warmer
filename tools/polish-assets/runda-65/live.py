# -*- coding: utf-8 -*-
"""Runda 65, Steg 14 — läs de åtta publicerade sidorna som kund.
...
# ☠️ Rundans säkerhetsrelevanta villkor IMPORTERAS ur lint — de kopierades
#    i runda 64, och en kopia är en tvilling som glider isär. Ett facit som
#    stämmer bevisar dem redan; listan står kvar för att felet ska peka på
#    RÄTT sak när något går sönder.
...
# ☠️ 2823c605 bild 4 bar tysk text inbränd i pixlarna och plockades ur
#    galleriet i Steg 9. Nämnaren är därför fyra på den produkten — läser
#    grinden bilder.json rakt av ser en KORREKT borttagning ut som ett fel.
BORT = {("2823c605", 4)}
