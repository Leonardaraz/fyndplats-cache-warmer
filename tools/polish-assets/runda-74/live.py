# -*- coding: utf-8 -*-
"""Runda 74, Steg 14 — läs de åtta publicerade sidorna som kund.
...
⚠️ Kortnålen är filens hex-del, inte hela filnamnet: Wix bygger om adressen
   med /v1/fill/ men hexen står kvar i sidkällan.
"""
