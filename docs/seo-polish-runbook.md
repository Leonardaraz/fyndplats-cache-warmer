...
> 🔒 **Tvätten gäller bara overlay-grafik, aldrig varan** — se den fasta regeln högst upp (inkl. avgörande-testet och misstagsfallen: för snäv beskärning, `rembg` som äter tunna delar). Är en husmärkeslogga tryckt på varan: **flagga till Leonard**, retuschera den aldrig. Osäker på om något ska tvättas? Flagga med före/efter-preview i chatten.
