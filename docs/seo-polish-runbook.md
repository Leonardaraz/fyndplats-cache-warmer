...
- 🔒 **Ändra ALDRIG utseendet på själva varan** (Leonards regel, uttalad 2026-08-06). Bildpolering får bara röra sådant som ligger **ovanpå** bilden — pålagd overlay-text, banderoller, vattenstämplar, callouts, rörig bakgrund. Allt som kunden faktiskt får i kartongen ska synas exakt som det är: **logotyper tryckta/graverade/gjutna på produkten** (både etablerade märken som Pagani Design och husmärken som VEVOR), färg, ytfinish, form, proportioner, medföljande delar. En bortretuscherad husmärkeslogga är vilseledande — kunden får ändå varan med loggan på. Sitter en husmärkeslogga fysiskt på varan: **flagga till Leonard**, rör den inte (produkten kan behöva bytas ut i sortimentet i stället). Osäker på om något ligger på varan eller ovanpå bilden? Utgå från att det sitter på varan och flagga.
...
> 🔒 **Varans utseende är okränkbart** — se den fasta regeln högst upp. Tvätten gäller **enbart overlay-grafik**: text, loggor, banderoller, vattenstämplar och callouts som är **pålagda i bildfilen**. Allt som sitter på den fysiska varan lämnas orört — loggor tryckta/graverade/gjutna på produkten (både etablerade märken som Pagani Design på urtavlan och husmärken som VEVOR på en paviljongduk), liksom färg, ytfinish, form och medföljande delar. Kunden får produkten med loggan; en bortretuscherad logga vore vilseledande.
>
> **Testet:** skulle detta fortfarande synas om du fotade varan själv efter uppackning? → **rör den inte**. Syns det bara för att någon lagt på det i efterhand i bildredigeraren? → tvätta bort.
>
> Är en husmärkeslogga tryckt på varan: **flagga till Leonard** (produkten kanske ska bytas ut i sortimentet) — retuschera aldrig bort den. Osäker på om något ska tvättas? Flagga med före/efter-preview i chatten.
